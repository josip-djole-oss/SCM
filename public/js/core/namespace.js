(function (global) {
  ...
  assignNamespace("admin", {
    ...
    openUserWizard: legacyMethod("openAdminUserWizard"),
    closeUserWizard: legacyMethod("closeAdminUserWizard"),
    userWizardNext: legacyMethod("adminUserWizardNext"),
    userWizardBack: legacyMethod("adminUserWizardBack"),
    userWizardGoTo: legacyMethod("adminUserWizardGoTo"),
    applyWizardPreset: legacyMethod("applyAdminUserWizardPreset"),
    generateWizardPassword: legacyMethod("generateAdminWizardPassword"),
    toggleWizardAllSites: legacyMethod("toggleAdminWizardAllSites"),
    saveUserWizard: legacyMethod("saveAdminUserWizard"),
